Pod::Spec.new do |s|
  ...
  s.source = { :git => 'https://github.com/playhaven/sdk-ios.git', :tag => s.version.to_s }
  ...
  s.platform = :ios, '5.1'
  # PlayHaven includes prefixed versions of SBJson
  s.source_files = 'Cache', 'src', 'JSON'

  s.frameworks = 'UIKit', 'Foundation', 'CoreGraphics', 'SystemConfiguration', 'CFNetwork', 'StoreKit',
